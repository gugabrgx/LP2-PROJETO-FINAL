 ...
 * <p>
 * Classe que representa um Item comercializado com quantidade fixa. Este tipo de item base possui nome, categoria,
 * unidade de medida, quantidade e precos. Nesta classe e possivel crir um item, adicionar um preco a um item,
...
public class ItemPorQuantidadeFixa extends Item {
     ...
     */
    public ItemPorQuantidadeFixa(String nome, String categoria, int qnt, String unidadeDeMedida, String localDeCompra, double preco) {
    ...
    public void atualizaItem(String atributo, String novoValor) {
        ...
        switch (atributo.trim().toLowerCase()) {
            ...
            case "unidade de medida":
                if (novoValor == null)
                    throw new NullPointerException("Erro na atualizacao de item: unidade de medida nao pode ser vazia ou nula.");
    ...
    public String toString() {
        return String.format("%s %d %s, Preco: %s", super.toString(), this.qnt, this.unidadeDeMedida, super.getListaPrecos());
    }
}
