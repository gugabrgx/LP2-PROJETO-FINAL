...
public class Controller {
    ...
    public String exibeItem(int id) {
        ...
        if (!itens.containsKey(id)) throw new NullPointerException("Erro na listagem de item: item nao existe.");
    ...
    public void atualizaItem(int id, String atributo, String novoValor) {
        ...
        if (!itens.containsKey(id)) throw new NullPointerException("Erro na atualizacao de item: item nao existe.");
