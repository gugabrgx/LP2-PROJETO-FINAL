...
public class Controller {
     ...
     * @param qnt             Um inteiro que representa a quantidade de produtos que se
     *                        encontram na embalagem do item.
     * @param unidadeDeMedida Uma String que representa a unidade de medida do produto (gramas,
     *                        litros, etc.).
    ...
    /**
     * Metodo que ordena os itens por ordem alfabetica, e retorna um item na posicao em que foi ordenado.
     *
    ...
    /**
     * Metodo que ordena os itens por categoria, e retorna um item na posicao em que foi ordenado.
     *
     * @param posicao A posicao em que o item esta posicionado ordenadamente.
     * @return Uma String que contem a exibicao de um item.
     */
    ...
    /**
     * Metodo que ordena os itens por preco, e retorna um item na posicao em que foi ordenado.
     *
     * @param posicao A posicao em que o item esta posicionado ordenadamente.
     * @return Uma String que contem a exibicao de um item.
     */
