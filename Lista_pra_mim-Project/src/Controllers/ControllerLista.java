...
public class ControllerLista {
    ...
    /**
     * Atributo que representa o controller de item, e permite este controler conhecer os itens cadastrados.
     */
    ...
    /**
     * Metodo que retorna uma lista com as listas criadas na data escolhida pelo usuario.
     *
    ...
    /**
     * Metodo que retorna uma lista com as listas que possuem o item escolhida pelo usuario.
     *
     ...
     *
     * @param id  O id do item.
     * @param msg Parte da mensagem de erro que sera lancada caso alguma excecao ocorra.
    ...
    /**
     * Metodo que verifica a validade e checa a existenciado do descritor de uma lista repassado pelo usuario
     *
     * @param descritorLista O descritor de uma lista.
     * @param erro           Parte da mensagem de erro que sera lancada caso alguma excecao ocorra.
     */
