...
public class ItemPorQuiloTest {
    ...
    /**  
     * Constrói um item com nome vazio,
    ...
    /**  
     * Constrói um item com nome nulo,
     * esperando uma excecao.
     */
    ...
    /**  
     * Constrói um item com categoria vazia,
     * esperando uma excecao.
     */
    @Test(expected = IllegalArgumentException.class)
    ...
    /**  
     * Constrói um item com categoria invalida,
     * esperando uma excecao.
     */
    @Test(expected = IllegalArgumentException.class)
    ...
    /**
     * Constrói um item com categoria nula,
     * esperando uma excecao.
     */
    @Test(expected = NullPointerException.class)
    ...
    /**
     * Constrói um item com localDeCompra vazia,
     * esperando uma excecao.
     */
    @Test(expected = IllegalArgumentException.class)
    ...
    /**
     * Constrói um item com localDeCompra nula,
     * esperando uma excecao.
     */
    @Test(expected = NullPointerException.class)
    ...
    /**
     * Testa o metodo atualizaItem com kg invalido,
     * eseprando uma excecao.
     */
    ...
    /**
     * Testa o metodo atualizaItem com kg menor que zero,
     * eseprando uma excecao.
     */
    @Test(expected = IllegalArgumentException.class)
    ...
    /**
     * Testa o metodo atualizaItem com atributo invalido,
     * eseprando uma excecao.
     */
    @Test(expected = IllegalArgumentException.class)
