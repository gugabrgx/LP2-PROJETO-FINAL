...
public class ItemPorQuantidadeFixaTest {
    ...
    /**
     * Constroi um item com nome vazio,
     * esperando uma excecao.
     */
    ...
    /**
     * Constroi um item com nome nulo,
     * esperando uma excecao.
     */
    ...
    /**
     * Constroi um item com categoria vazia,
     * esperando uma excecao.
     */
    @Test(expected = IllegalArgumentException.class)
    ...
    /**
     * Constroi um item com categoria invalida,
     * esperando uma excecao.
     */
    @Test(expected = IllegalArgumentException.class)
    ...
    /**
     * Constroi um item com categoria nula,
     * esperando uma excecao.
     */
    @Test(expected = NullPointerException.class)
    ...
    /**
     * Constroi um item com localDeCompra vazia,
     * esperando uma excecao.
     */
    @Test(expected = IllegalArgumentException.class)
    ...
    /**
     * Constroi um item com localDeCompra nula,
     * esperando uma excecao.
     */
    @Test(expected = NullPointerException.class)
    ...
    /**
     * Constroi um item com quantidade inválida,
     * esperando a excecao.
     */
    @Test(expected = IllegalArgumentException.class)
    ...
    /**
     * Constroi um item com preco invalido,
     * esperando uma excecao.
     */
    @Test(expected = IllegalArgumentException.class)
    ...
    /**
     * Testa o método atualizaItem com categoria invalida, 
     * esperando a excecao.
     */
    @Test(expected = IllegalArgumentException.class)
    ...
    /**
     * Testa o método atualizaItem com quantidade invalida,
     * esperando a excecao.
     */
    @Test(expected = IllegalArgumentException.class)
    ...
    /**
     * Testa o método atualizaItem com quantidade menor que zero,
     * esperando a excecao.
     */
    @Test(expected = IllegalArgumentException.class)
    ...
    /**
     * Testa o atualiza item com unidade de medida vazia,
     * esperando a excecao.
     */
    @Test(expected = IllegalArgumentException.class)
    ...
    /**
     * Testa o atualiza item com unidade de medida nula,
     * esperando a excecao.
     */
    @Test(expected = NullPointerException.class)
    ...
    /**
     * Testa o metodo de adicionar preco com mercado vazio,
     * esperando a excecao.
     */
    @Test(expected = IllegalArgumentException.class)
    ...
    /**
     * Testa o metodo de adicionar preco com mercado nulo,
     * esperando a excecao.
     */
    @Test(expected = NullPointerException.class)
    ...
    /**
     * Testa o metodo de adicionar preco com preco invalido, 
     *esperando a excecao.
     */
    @Test(expected = IllegalArgumentException.class)
